...
public class LogAttackWindow extends CustomBaseListWindow {
	...
	public void getServerData(ResultPage resultPage) throws GameException {
		...
		StaticUserDataQueryResp resp = GameBiz
				.getInstance()
				.staticUserDataQuery(
						StaticUserDataType.STATIC_USER_DATA_TYPE_BFIEF_BATTLE_LOG_ATTACK,
						log == null ? 0 : log.getId(), resultPage.getPageSize());
		List<BattleLogClient> lics = BattleLogClient.convertList(
				resp.getBriefBattleLogs(), true);
