...
import com.vikings.sanguo.protos.MsgRspEquipmentInsertItemLevelup;

public class EquipmentInsertItemLevelUpResp extends BaseResp {
	...
	protected void fromBytes(byte[] buf, int index) throws Exception {
		MsgRspEquipmentInsertItemLevelup rsp = new MsgRspEquipmentInsertItemLevelup();
