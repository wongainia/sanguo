...
public final class BattleHeroInfo implements Externalizable, Message<BattleHeroInfo>, Schema<BattleHeroInfo>
{
    ...
    public BattleHeroInfo setHero(Long hero)
    {
        this.hero = hero;
        return this;
    }
    ...
    public BattleHeroInfo setHeroid(Integer heroid)
    {
        this.heroid = heroid;
        return this;
    }
    ...
    public BattleHeroInfo setUserid(Integer userid)
    {
        this.userid = userid;
        return this;
    }
    ...
    public BattleHeroInfo setType(Integer type)
    {
        this.type = type;
        return this;
    }
    ...
    public BattleHeroInfo setRole(Integer role)
    {
        this.role = role;
        return this;
    }
    ...
    public BattleHeroInfo setTalent(Integer talent)
    {
        this.talent = talent;
        return this;
    }
    ...
    public Class<BattleHeroInfo> typeClass()
    {
    ...
    public boolean isInitialized(BattleHeroInfo message)
    {
        return true;
    }

    public void mergeFrom(Input input, BattleHeroInfo message) throws IOException
    {
    ...
    public void writeTo(Output output, BattleHeroInfo message) throws IOException
    {
        ...
        if(message.talent != null)
            output.writeUInt32(60, message.talent, false);
    }
