...
public class RotateAnimation  extends Animation {  
    ...
    /** Z轴上最大深度。 */  
    public static final float DEPTH_Z = -100.0f;  
    /** 动画显示时长。 */  
    ...
    public RotateAnimation(float cX, float cY, boolean type,int index) {  
        centerX = cX;  
        centerY = cY;  
        this.type = type;  
    ...
    protected void applyTransformation(float interpolatedTime, Transformation transformation) {  
    	...
    	//Log.d("GroupRefreshWindow", "interpolatedTime--" + interpolatedTime + "---index" + index);
        if (listener != null) {  
            listener.interpolatedTime(interpolatedTime,index);  
        }  
...
//        } else 
        {  
            ...
            //matrix.preScale(1+0.625f*interpolatedTime, 1,centerX,centerY);
        }  
    }  
